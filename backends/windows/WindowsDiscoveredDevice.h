...
class WindowsDiscoveredDevice final : public RgbDevice
{
    Q_OBJECT

public:
    explicit WindowsDiscoveredDevice(const hardware::windows::ProbeDevice& device, QObject* parent = nullptr);
...
private:
    ...
    QString m_path;
    QString m_details;
    hardware::windows::DiscoverySupportInfo m_support;
};
