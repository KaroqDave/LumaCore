...
inline constexpr RgbControllerCatalogEntry kRgbControllerCatalog[] {
    ...
    },
    {
        ...
        "research-only",
        "read-only research candidate",
        "ASUS Aura addressable-header USB controller recorded for inventory and future research only.",
        "Source: OpenRGB AsusAuraUSBControllerDetect.cpp @ 9f82afa4. Do not enable writes without owned-hardware captures, config-table tests, and explicit packet verification.",
        false,
    },
    {
        "0B05",
    ...
    },
    {
        ...
        "research-only",
        "read-only research candidate",
        "ASUS Aura mainboard USB controller recorded for inventory and future research only.",
        "Source: OpenRGB AsusAuraUSBControllerDetect.cpp @ 9f82afa4. Do not enable writes without owned-hardware captures, config-table tests, and explicit packet verification.",
        false,
    },
    {
        ...
        "research-only",
        "read-only research candidate",
        "ASUS ROG Aura Terminal addressable USB controller recorded for inventory and future research only.",
        "Source: OpenRGB AsusAuraUSBControllerDetect.cpp @ 9f82afa4. Do not enable writes without owned-hardware captures, config-table tests, and explicit packet verification.",
        false,
    },
};
